...
played game. The beneficiaries here are the protocol, the creator of the game
and the creators of the towers. Each of these actors can provide a beneficiary
address to capture their share of fees generated by the game. Note that the
described design enables the approach of decentralized frontend hosting in which
entities may provide different frontends with different graphic design and
appeal. They then may capture game or tower fees via their own distribution
channels. The fee distribution for a game may look like this.
